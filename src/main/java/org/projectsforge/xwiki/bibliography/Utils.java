...
public class Utils {
   ...
   * @return the CSL name[]
   */
  public static CSLName[] convertValueToCSLNames(BibliographyService service, String value) {
    if (StringUtils.isBlank(value)) {
   ...
   */
  public static CSLItemData deserializeCSLItemData(BibliographyService service, String value) {
  ...
  public static List<String> deserializeKeys(BibliographyService service, String value) {
    if (StringUtils.isNotBlank(value)) {
      try {
   ...
   * @return the string
   */
  public static String serializeKeys(BibliographyService service, List<String> keys) {
    try {
      if (!keys.isEmpty()) {
